    ...
    return Container(
              ...
              child: Column(
                ...
                InkWell(
                  onTap: ()  {
                    Get.back();
                    Get.toNamed(Routes.PEMBAYARAN_TUNAI, parameters: {'nr': kasir.noRegistrasi ?? ''}, arguments: kasir);
                  },
                child : Container(
                  ...
                  child: Row(
                    ...
                    InkWell(
                      onTap: () {
                        Get.back();
                        Get.toNamed(Routes.PEMBAYARAN_KARTU_DEBET, parameters: {'nr': kasir.noRegistrasi ?? ''}, arguments: kasir);
                      },
                    child : Container(
                      padding: EdgeInsets.all(10),
                      margin: EdgeInsets.only(right: 10, left: 10),
                      ...
                      child: Row(
                          ...
                          children: [
                            ...
                            Text('Kartu Debet', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold,)),
                          ]),
                    ),),
                    SizedBox(
                      height: 10,
                    ...
                    child : Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            ...
                            Text('Kartu Kredit', style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                          ]),
                    ),),
