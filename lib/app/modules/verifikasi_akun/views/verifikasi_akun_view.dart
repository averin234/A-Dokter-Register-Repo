              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: Text(
                          "Pastikan data yang di input sudah bener",
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          child : InkWell(
            ...
            child: Text('Lewati', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blue)),
          ),
          ),
          SizedBox(
            width: 20,
        ...
        children: [
          ...
          const Padding(
            ...
            Text("No.SIP ",
              ...
              Text("(*)",
                  style: TextStyle(fontWeight: FontWeight.normal, color: Colors.redAccent)),
            ],),
          ),
          const SizedBox(
            height: 10,
            ...
            child: TextField(
              ...
              onTap: () async {
                ...
                if(pickedDate != null ){
                  ...
                  setState(() {
                    controller.tanggalMulaiBerlakuController.text = formattedDate; //set output date to TextField value.
                  });
                }else{
            ...
            child: TextField(
              ...
              onTap: () async {
                ...
                if(pickedDate != null ){
                  ...
                  setState(() {
                    controller.tanggalAkhirBerlakuController.text = formattedDate; //set output date to TextField value.
                  });
                }else{
                  print("Date is not selected");
                }
          ...
          child : Row(
            ...
            Row(children: [
              ...
              Container(
                ...
                child : Text('Upload Dokumen', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),)
              )
          ],
          ),),
          ],),),
