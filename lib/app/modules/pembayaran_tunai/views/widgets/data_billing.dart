...
import '../../controllers/pembayaran_tunai_controller.dart';
  ...
  class Databilling extends GetView<PembayaranTunaiController> {
    final GetTunai tunai;
  const Databilling(this.tunai, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(children:
          tunai.harga!.map((e) => Text(e.billRs ?? '')).toList()
        //   const SizedBox(
        //     height: 25,
        //   ),
        //   const Padding(
        ...
        //                             ),
        //                             child: Text(tunai.harga![0].billRs ??''),
        //                         ),
        //                       ),
        //                     ],
        //                   ),
        ...
        //                       MainAxisAlignment.spaceBetween,
        //                       children:
        //                         tunai.harga!.map((e) => Text(e.billRs ??'',
        //                             style: TextStyle(
